...
import type { EngagementSection, SectionInput } from "../../types";

const C = COMMON_LABELS;
const L = ENGAGEMENT_LABELS.section;
...
interface SectionFormDialogProps {
  ...
  initialData?: EngagementSection | null;
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="VD: Kiểm tra quy trình thu mua" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Mô tả phần kiểm toán..." rows={3} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
