  ...
  switch (action.type) {
    ...
    case "EXPAND_SECTION_FORM":
      return {
        ...
        editingSectionData: { id: "", engagementId: "", title: action.title, description: null, status: "draft", addedFrom: "execution", sortOrder: 0, reviewNotes: null, reviewedBy: null, reviewedAt: null, objectives: [], procedures: [] },
      };
    ...
    case "EXPAND_OBJECTIVE_FORM":
      return {
        ...
        editingObjectiveData: { id: "", title: action.title, description: null, sectionId: action.sectionId, status: "draft", addedFrom: "execution", sortOrder: 0, reviewNotes: null, reviewedBy: null, reviewedAt: null, procedures: [] },
      };
