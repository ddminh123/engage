export const API_ROUTES = {
  ...
  ENGAGEMENT_CONTROLS: (id: string) => `/api/engagement/${id}/controls`,
  ENGAGEMENT_CONTROL_BY_ID: (id: string, cId: string) => `/api/engagement/${id}/controls/${cId}`,
  ENGAGEMENT_RISK_CONTROL_LINK: (id: string, rId: string) => `/api/engagement/${id}/risks/${rId}/controls/link`,
